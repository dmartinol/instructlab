...
# This is copied from https://github.com/instructlab/sdg/blob/main/src/instructlab/sdg/utils/taxonomy.py
# We could just import instructlab.sdg.utils.taxonomy, but SDG is undergoing a major refactoring and the contract for its code is changing so it is unwise to depend on it.
# Eventually this will all be reconciled.
